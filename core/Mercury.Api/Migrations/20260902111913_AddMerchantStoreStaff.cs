...
{
    /// <inheritdoc />
    public partial class AddMerchantStoreStaff : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_staff_members_asp_net_users_identity_user_id",
                        column: x => x.identity_user_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_staff_members_merchants_merchant_id",
                        column: x => x.merchant_id,
                        principalTable: "merchants",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_staff_members_stores_store_id",
                        column: x => x.store_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_staff_members_identity_user_id",
                table: "staff_members",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_staff_members_store_id",
                table: "staff_members",
                column: "store_id");
